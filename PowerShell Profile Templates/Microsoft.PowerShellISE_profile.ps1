...
$Global:transcriptLocation = "$ODPersonalLocation\Transcripts\Ise"
...
#----------------------------------------------------#
# Open RemoteSessionTemplates.ps1 which shows list of 
# functions loaded from profile.
#----------------------------------------------------#
#ise "$ODPersonalLocation\RemoteSessionTemplates.ps1"
...
#----------------------------------------------------#
# Time until Wedding Anniversary
#----------------------------------------------------#
$tillWeddingAnniversary = (Get-Date "October 7") - (Get-Date)
Write-Host ("`n{0} Days, {1} Hours, {2} Minutes, {3} seconds till Oct 7th! Our Wedding Anniversary!!" -f $tillWeddingAnniversary.Days, $tillWeddingAnniversary.Hours, $tillWeddingAnniversary.Minutes, $tillWeddingAnniversary.Seconds)
