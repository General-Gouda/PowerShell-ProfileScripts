...
function New-EncryptedString
{
	...
	function New-SelfSignedCert
	{
		...
		$ekuext = New-Object -ComObject "X509Enrollment.CX509ExtensionEDOMAINncedKeyUsage.1"
...
Export-ModuleMember -Function Get-DecryptedPassword, Get-EncryptedString, New-EncryptedString
